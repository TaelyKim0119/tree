      ...
      {pillars.map(({ label, key, highlight }) => {
        ...
        return (
          <div key={key} className="text-center space-y-2">
            ...
            <div className={`w-[70px] h-[88px] rounded-2xl overflow-hidden relative shadow-xl ${highlight ? 'ring-2 ring-amber-400/30' : 'ring-1 ring-white/5'}`}>
            ...
            <div className={`w-[70px] h-[88px] rounded-2xl overflow-hidden relative shadow-xl ${highlight ? 'ring-2 ring-amber-400/20' : 'ring-1 ring-white/5'}`}>
